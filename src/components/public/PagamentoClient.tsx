...
import { Copy, CheckCircle2, MessageCircle, Clock, Loader2, ExternalLink, ShieldCheck } from "lucide-react";
        ...
        {pixQrUrl || pixCode ? (
          <>
            ...
            <div className="bg-dark-surface rounded-2xl border border-dark-border p-5 space-y-3 mb-6">
              ...
              {[
                "Abra o app do seu banco (ou toque em \"Abrir página de pagamento\" acima)",
